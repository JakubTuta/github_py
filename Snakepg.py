...
class Snake:
    ...
    def draw(self, WIN):
        for x, y in self.snakeParts:
            pygame.draw.rect(
                WIN, GREEN, (x * DIMENSIONS, y * DIMENSIONS, DIMENSIONS, DIMENSIONS)
            )
...
class Apple:
    ...
    def draw(self, WIN):
        pygame.draw.circle(
            ...
            RED,
            (
                self.appleX * DIMENSIONS + DIMENSIONS / 2,
                self.appleY * DIMENSIONS + DIMENSIONS / 2,
            ),
            DIMENSIONS / 2,
        )
...
def draw(WIN, snake, apple, snake_parts):
    ...
    WIN.blit(
        font.render(f"Score: {snake.length - snake_parts}", True, WHITE),
