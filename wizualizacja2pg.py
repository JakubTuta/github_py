...
SETTINGS = {}
COLORS = {"WHITE": (255, 255, 255), "GREEN": (0, 255, 0), "GRAY": (100, 100, 100)}
...
def settings():
    ...
    Label(top, text="Podaj ilość liczb:", font=("Times New Roman", 20)).grid(
        row=0, column=0, padx=20, pady=10
    )
    Label(top, text="(1 - 512)", font=("Times New Roman", 15, "italic")).grid(
        row=1, column=0, padx=10, pady=10
    )
    Label(top, text="Wybierz rodzaj sortowania:", font=("Times New Roman", 20)).grid(
    ...
    Radiobutton(
        ...
        variable=sortingAlgorythm,
        value="bubble",
        font=("Times New Roman", 15),
    ).grid(row=1, column=1, padx=10, pady=10, sticky=W)
    Radiobutton(
        top,
        text="Sortowanie przez wstawianie",
        variable=sortingAlgorythm,
        value="insertion",
        font=("Times New Roman", 15),
    ...
    Radiobutton(
        top,
        text="Sortowanie przez wybieranie",
        variable=sortingAlgorythm,
        value="selection",
        font=("Times New Roman", 15),
    ...
    Radiobutton(
        top,
        text="Sortowanie grzebieniowe (comb sort)",
        variable=sortingAlgorythm,
        value="comb",
        font=("Times New Roman", 15),
    ...
    Radiobutton(
        top,
        text="Sortowanie pozycyjne (radix sort)",
        variable=sortingAlgorythm,
        value="radix",
        font=("Times New Roman", 15),
    ...
    Label(
        top,
        text="Wybierz prędkość sortowania (niższa liczba - szybsze sortowanie):",
        font=("Times New Roman", 15),
    ).grid(row=9, column=0, columnspan=2, padx=10, pady=20)
    ...
    Button(
        ...
        text="Pokaż!",
        font=("Times New Roman", 15),
        command=lambda: zamknij(
            sortingAlgorythm.get(), iloscLiczb.get(), delayScale.get()
        ),
    ).grid(row=11, column=0, columnspan=2, padx=10, pady=10, ipadx=30)
